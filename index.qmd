...
### [**Cancún AGEB**]{style="color:#990000"}
...
loc <- rgeomex::extract_locality(cve_edo = "23", 
                                 locality = "Cancun")
...
::: {.box .b}
```{r forest_plot_cancun_hex, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cancun_hex,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_cancun_hex,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_cancun_hex, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cancun_hex, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_chetumal, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_chetumal,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_chetumal,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_chetumal, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_chetumal, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_cozumel, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cozumel,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_cozumel,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_cozumel, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cozumel, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_felipe_carrillo_puerto}
# Step 1. extract the locality ####
loc <- rgeomex::extract_locality(cve_edo = "23", 
                                 locality = "Felipe Carillo Puerto")
...
::: {.box .b}
```{r forest_plot_felipe_carillo, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_felipe_carrillo,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_felipe_carrillo,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_felipe_carrillo, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_felipe_carrillo, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_playa, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_playa,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_playa,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_playa, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_playa, out.height='90%', out.width = '90%', fig.align = "center"}
...
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_23_quintana_roo,
                           locality = "Cancun",
                           cve_edo = "23",
...
```{r vector_hotspots_playa, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_23_quintana_roo,
                           locality = "Playa del Carmen",
                           cve_edo = "23",
                           palette = rcartocolor::carto_pal,
...
denhotspots::risk_ageb(betas = denmex::eggs_betas_23_quintana_roo,
...
### [**Playa del Carmén**]{style="color:#990000"}
